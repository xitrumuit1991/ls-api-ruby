class Acp::RedeemsController < Acp::ApplicationController
  ...
  def edit
    @broadcasters = Redeem.all.order('id desc')
  end
  ...
  private
    ...
    def parameters
      params.require(:data).permit(:code, :name, :coin, :status, :start_date, :end_date)
    end
end